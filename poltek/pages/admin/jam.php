...
if(!isset($_SESSION['admin'])){
  ...
  $cari = $_POST['cari'];
    ...
    if(isset($_GET['aksi']) && $_GET['aksi'] == 'hapus'){
        ...
        $result = mysql_query("DELETE from tb_jam where id_jam = '$id_jam'");

        echo "<script language = javascript> document.location='home.php?pages=jam&submit=hapus'; </script>";
        if($result == true){
        }
        else { echo "<script language = javascript> alert('Data Gagal Dihapus'); document.location='home.php?pages=jam'; </script>"; }
        }
    ...
    if(isset($_GET['aksi']) && $_GET['aksi'] == 'tambah'){
        ...
        $jam_selesai = $_POST['jam_selesai'];
            ...
            mysql_query("INSERT into tb_jam (jam, jam2) values ('$jam_mulai', '$jam_selesai')");
            
            echo "<script language = javascript> document.location='home.php?pages=jam&submit=sukses'; </script>";
    }
    ...
    if (isset($_GET['aksi']) && $_GET['aksi'] == 'edit'){
        ...
        mysql_query("UPDATE tb_jam set jam = '$jam_mulai', jam2 = '$jam_selesai' where id_jam = '$id_jam'");
       echo "<script language = javascript> document.location='home.php?pages=jam&submit=berhasil'; </script>";
    } 
?>
<body>
            <div class="row">
                ...
                <div class="col-sm-12">
                            ...
                            <form role="form" method="post" action="home.php?pages=jam&aksi=tambah">
