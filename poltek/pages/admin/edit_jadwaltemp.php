...
if(!isset($_SESSION['admin'])){
  ...
  $admin = $_SESSION['admin'];
    ...
    $s = mysql_query("select a.*, b.*, c.*, d.*, e.*, f.*, g.* from tb_jadwaltemp a
                            inner join tb_tingkat b on b.id_tingkat = a.id_tingkat
                            inner join tb_matkul c on c.id_matkul = a.id_matkul
                            inner join tb_kelas d on d.id_kelas = a.id_kelas
                            inner join tb_posisi e on d.id_posisi = e.id_posisi
                            inner join tb_prodi g on b.id_prodi = g.id_prodi
                            inner join tb_jurusan f on g.id_jur = f.id_jur where a.id_jtemp = '$id_jtemp' ");
            ...
            <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="glyphicon glyphicon-folder-open"></i> &nbsp; <a href="home.php?pages=jurusan">Master Data Penjadwalan Sementara</a>
                            </li>
                            <li class="active">
                                <i class="glyphicon glyphicon-pencil"></i>&nbsp; Edit Data Penjadwalan Sementara
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                            ...
                            <form role="form" method="post" action="home.php?pages=jadwaltemp&aksi=edit">
                            <div class="form-group">
                                <input type="hidden" name="id_jtemp" value="<?php echo $data['id_jtemp'];?>">
                            ...
                            <div class="form-group">
                                <div class="input-group clockpicker" data-autoclose="true">
                                   <input type="text" name="jam_selesai" class="form-control" value="<?php echo $data['id_jam2']?>" title="Jam Mulai">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="input-group date" id="tgl4">
                                    <input type="text" class="form-control" placeholder="Tanggal" value="<?php echo $data['tgl_temp']?>"name="tgl"/>  
    ...
    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style ="text-align:center"><a href = "home.php?pages=editjadwaltemp&id_trans=<?php echo $row['id_trans']?>"><i class = "glyphicon glyphicon-edit" title="Ubah Data"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href = "home.php?pages=jadwaltemp&id_trans=<?php echo $row['id_jtemp']?>&aksi=hapus" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"><i class = "glyphicon glyphicon-trash" title="Hapus Data"></i></a></td>
            </tr>
            <?php } ?>
        </tbody>
    </table>
