...
error_reporting(1);
  ...
  $cari = $_POST['cari'];
    ...
    $s = mysql_query("SELECT * from tb_kelas where id_kelas = '$id_kelas' ");
...
<body>
            <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="glyphicon glyphicon-folder-open"></i> &nbsp; <a href="home.php?pages=jurusan">Master Data Kelas</a>
                            </li>
                            <li class="active">
                                <i class="glyphicon glyphicon-pencil"></i>&nbsp; Edit Data Kelas
                            </li>
                        </ol>
                    </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                            ...
                            <form role="form" method="post" action="home.php?pages=master_kelas&aksi=edit">
                            <input type="hidden" name="id_kelas" value="<?php echo $data['id_kelas'];?>">
                            <div class="form-group" >
                                <input class="form-control" name="nama_kelas" type="text" placeholder="Nama Kelas" value="<?php echo $data['nama_kelas'];?>" required autofocus>
                            </div>
                            <div class="form-group">
                                <select class="selectpicker" name="posisi" data-live-search="true" title="Posisi">
                                <?php
                                    $sqll = mysql_query("SELECT * from tb_posisi order by posisi"); 
                            ...
                            <div class="form-group">
                                <input class="form-control" name="kapasitas" type="number" placeholder="Kapasitas" value="<?php echo $data['kapasitas'];?>" required autofocus>
                            </div>
